...
INPUT_CSV = "all_datasets_with_labels_dedup_1.csv"          # 原始数据
OUTPUT_CSV = f"./llm/{MODEL_NAME}/new_annotated_data_1.csv"            # 标注后的打分数据表
OUTPUT_LEXICON_CSV = f"./llm/{MODEL_NAME}/extracted_lexicon_1.csv"     # 提取的敏感词记录表
